...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.create_user_button = QAction('Регистрация пользователя', self)
        self.remove_user_button = QAction('Удаление пользователя', self)
        ...
        self.toolbar.addAction(self.create_user_button)
